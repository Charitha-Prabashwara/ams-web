...
export default function LecturerPage() {
  ...
  // ---------- FETCH USERS ----------
  const { data: usersData, error: usersError, mutate } = useSWR(['/admin/find/', { type: 'student' }], fetcher);
  ...
  return (
    <MainCard title="Head of Departments">
      <UniversalActionBar buttons={[{ label: 'Create Student', color: 'success', onClick: () => setOpenCreate(true) }]} />
