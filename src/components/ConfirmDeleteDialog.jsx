...
import { Dialog, DialogTitle, DialogContent, DialogActions, Typography, TextField, Button, Fade } from '@mui/material';
  ...
  return (
    ...
    >
      ...
      <DialogActions>
        ...
        <Button color="error" variant="contained" disabled={!isMatch} onClick={onConfirm}>
          {confirmLabel}
        </Button>
      </DialogActions>
    </Dialog>
